  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Book Story v1 - Empowering Book Creators with Innovative SaaS Solutions, Your Canvas for Crafting Literary Masterpieces."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Book Story v1 - Empowering Book Creators with Innovative SaaS Solutions, Your Canvas for Crafting Literary Masterpieces.`}
            </Text>
            <Box
